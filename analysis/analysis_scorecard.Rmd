...
The final variable that was selected to potentially control for endogeneity was the percentage of undergraduates aged 25 or older. Older graduates could have multiple characteristics that could bias the high-earning treatment variable by influencing decisions to search for higher-earning schools independent of the scorecard. They could be more likely to be attending school for financial reasons which could result in them in doing their own in-depth research into maximizing the highest paying outcomes. Their additional work experience and incomes could increase their ability to get into more academically rigorous schools regardless of interest in future financial benefits.
...
m7 <- scorecard_f %>% feols(ind_z_shift ~ high_earning + stem_pri)
m8 <- scorecard_f %>% feols(ind_z_shift ~ high_earning + stem_pri | CONTROL, se = "hetero")

m15 <- scorecard_f %>% feols(ind_z_shift ~ high_earning + stem_pri | CONTROL, se = "hetero")
m16 <- scorecard_f %>% feols(ind_z_shift ~ high_earning + stem_pri + UG25abv | CONTROL, se = "hetero")
